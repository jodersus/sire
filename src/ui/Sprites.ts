...
export interface SpriteSheet {
  terrain: Record<string, HTMLCanvasElement>;
...
function createHexSprite(size: number, fill: string, stroke: string): HTMLCanvasElement {
...
function createUnitSprite(size: number, tribeColor: string, icon: string): HTMLCanvasElement {
  const canvas = document.createElement('canvas');
  canvas.width = size + 4;
...
const spriteCache: {
  hex: Map<string, HTMLCanvasElement>;
  unit: Map<string, HTMLCanvasElement>;
} = {
  hex: new Map(),
  unit: new Map(),
};
 ...
 */
export function getHexSprite(terrain: string, size: number = 32): HTMLCanvasElement {
 ...
 */
export function getUnitSprite(tribeColor: string, icon: string, size: number = 32): HTMLCanvasElement {
...
export function preloadSprites(size: number = 32): void {
