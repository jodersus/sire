...
export type TerrainType = 'plains' | 'mountain' | 'water' | 'desert' | 'forest' | 'unknown';
...
export interface HexCell {
  ...
  terrain: TerrainType;
  unit?: UnitInfo;
  highlight?: 'hover' | 'selected' | 'move' | 'attack';
}

export interface UnitInfo {
  tribeColor: string;
  icon: string; // letra o símbolo simple
}
...
export function drawHexGrid(
  ...
  const order: Record<TerrainType, number> = {
