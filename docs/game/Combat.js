...
import { getCityDefense } from './City.js';
/** Crear instancia de unidad desde definición */
export function createUnitInstance(id, type, ownerId, x, y) {
...
export function calculateDamage(attacker, defender, attackerTerrain, defenderTerrain, 
...
export function resolveCombat(attacker, defender, attackerTerrain, defenderTerrain, tribeAttackBonus = 0) {
    const { attackerDealt, defenderDealt } = calculateDamage(attacker, defender, attackerTerrain, defenderTerrain, tribeAttackBonus);
...
export function resolveSiege(attacker, city, attackerTerrain, tribeAttackBonus = 0) {
...
export function canAttackTarget(attacker, defender, attackerDef) {
